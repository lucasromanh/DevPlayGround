...
async function initPyodide() {
    ...
    // Configurar stdin (Manejo de input())
    pyodide.setStdin({
        stdin: (context) => {
            if (self.sharedBuffer) {
                ...
                // Fallback si no hay SharedArrayBuffer (Aislamiento de origen)
                console.warn("Módulo de entrada (input) limitado: Se requiere aislamiento de origen (SAB).");
